...
import {default as getUid} from './uid';
import {default as attrAccept} from './attr-accept';

class AjaxUploader extends React.Component<any, any> {
  fileInput;
  state = { uid: getUid() }
  reqs = {}
  ...
  post(file) {
    ...
    this.reqs[uid] = request({
      action: props.action,
      filename: props.filename ? props.filename : file.name,
      file,
      data,
      formDataFileFiled: props.formDataFileFiled,
